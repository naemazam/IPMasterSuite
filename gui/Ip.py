...
from PyQt5.QtWidgets import QWidget, QLabel, QLineEdit, QPushButton, QHBoxLayout, QVBoxLayout, QSlider, QMessageBox, QSpinBox
...
class Ip(QWidget):
    def __init__(self):
        ...
        self.net_mask_size = QSpinBox()
        self.net_mask_size.setValue(self.slider.value())
        self.net_mask_size.setMinimum(1)
        self.net_mask_size.setMaximum(31)
        self.update_netmask(24)
        ...
        self.slider.valueChanged.connect(lambda event: self.update_netmask(event))
        self.net_mask_size.valueChanged.connect(lambda event: self.update_netmask(event))
    ...
    def update_netmask(self, event):
        dot_decimal = make_net_mask(event)
        self.net_mask_input.setText(dot_decimal)
        self.net_mask_size.setValue(event)
        self.slider.setValue(event)
    ...
    #     self.net_mask_input.setText(dot_decimal)
    #     self.net_mask_size.setValue(ones)
